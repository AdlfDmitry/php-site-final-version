...
<body>
    <header>
        <div class="logo">
            <img src="img/log 1.png" alt="Simple Bank Logo" onclick="window.location.href='admin_panel.php'">
        </div>
        <h1>Simple Bank</h1>
        <nav>
            <ul>
    ...
    <section class="hero">
     ...
     <div class="container">
       <center> <h1>Terminals of Banking System</h1> </center>
         <div class="button-container">
          <center>   
              <button class="btn" onclick=" window.location.href='customer_delete.php'">Remove data </button>
              <button class="btn" onclick="window.location.href='add_terminal.php'">Add data </button> 
...
<script>
    function redirect() {
        ...
        <table class="custom-table">
            ...
            <tbody>
                <?php include 'terminal_output.php'; ?>
            </tbody>
        </table>
